              ...
              <>
                ...
                <div className="px-2.5 py-2">
                  ...
                  <div className="flex gap-1">
                    <input
                      aria-label="视频链接"
                      className="min-h-11 min-w-0 flex-1 rounded-md border border-[var(--border-subtle)] bg-[var(--surface-input)] px-2.5 py-1.5 text-xs text-[var(--text-strong)] outline-none placeholder:text-[var(--text-faint)]"
